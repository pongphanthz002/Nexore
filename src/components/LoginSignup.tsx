    ...
    <div className="min-h-screen bg-black flex items-center justify-center overflow-hidden relative">
      ...
      >
        ...
        <motion.button
          ...
          onClick={handleSignIn}
          disabled={loading}
          className="w-full bg-black-500 border-2 border-neon-glow rounded-xl p-4 text-left group hover:bg-black-400 transition-all disabled:opacity-50"
        >
